...
@Component({
  selector: 'app-quality-department-quantity',
  templateUrl: './quality-department-quantity.component.html',
  styleUrls: ['./quality-department-quantity.component.scss']
})
export class QualityDepartmentQuantityComponent implements OnInit {
  cellTotal: number;
  rowItem: IQuality
  rowData: any
  columnDefs: any
  ...
  constructor(private qualityService: QualityService, 
              private dialog: MatDialogRef<QualityDepartmentQuantityComponent>, 
